...
(function () {
  ...
  var CHAPTERS = [
    ...
    },
    {
      ...
      pts: 23, lines: 175, role: 'P0 定档问卷 · 必经入口',
    ...
    },
    {
      ...
      pts: 68, lines: 298, role: 'P1 组成可查 · 判点最多',
    ...
    },
    {
      ...
      pts: 38, lines: 189, role: 'P3 · 必查不可跳',
    ...
    },
    {
      ...
      pts: 16, lines: 92, role: '收口层 · 不新增检查面',
    ...
    },
    {
      ...
      pts: 0, lines: 76, role: '全程 · 检查者纪律',
      desc: '不评什么（Out of Scope 五条）+ 验收者反模式自查六条 + 证据来源纪律。读完才够格当检查者，自查动作本身要留痕。',
      secs: ['A.1 Out of Scope（不评什么）', 'A.2 验收者反模式自查（不犯什么）', 'A.3 证据来源纪律（从哪取）', '附录收口：检查者出师自检']
    },
    {
      no: 'B', file: '附录B-脚手架型通用接入模板.md', name: '附录 B 脚手架型通用接入模板', color: '#6d28d9',
      pts: 0, lines: 337, role: '脚手架型项目 · 通用模板',
    ...
    children: [
      ...
      { name: 'skill.json', type: 'file', desc: '机器可读元数据，与 frontmatter 双写同步，含 15 个关键词', badge: '发布物' },
      {
        ...
        children: [
          ...
          { name: '附录B-脚手架型通用接入模板.md', type: 'file', desc: '脚手架型通用模板：红线清单 + 护栏/评估/反思接入位置示例 + 安全测试框架扩展模板', badge: '5 模板' }
        ]
      },
      {
