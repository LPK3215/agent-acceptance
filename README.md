...
- [00 全局地图](references/00-global-map.md)
...
- 快速初判：沿主线执行定档、系统组成抽查、安全底线与结论，单次会话给出结果
- 红线急查：仅核查安全底线与结论，回答当前能否放行
- 分批全量：按章逐步开查，十章收口后合成完整验收结论单
...
结果：随问随答的讲解向导。可先从 [00 全局地图](references/00-global-map.md) 开始通读正文，判据可与 GB/T 25000.51、OWASP Agentic AI Top 10、Agent Card 等外部框架对照。
